...
def opt5(citibikes):
    ...
    print (f" Las 3 estaciones principales a las que mas bicicletas llegan provenientes de otras estaciones: {rta[0]} , Las 3 estaciones de las que más viajes salen hacia otras estaciones: {rta[1]} , las 3 estaciones menos utilizadas por los turistas: {rta[0]}")
